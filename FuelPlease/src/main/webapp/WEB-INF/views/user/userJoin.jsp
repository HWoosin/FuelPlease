...
<head>
	...
	<section>
		<div class="container-fluid">
			...
			<link href="${pageContext.request.contextPath }/vendor/bootstrap-icons/bootstrap-icons.css"
				rel="stylesheet">
		...
		<div class="row">
			<div class="col-lg-6 col-md-9 col-sm-12 join-form">
				...
				<form action="${pageContext.request.contextPath}/user/userJoin" method="post" name="joinForm">
					...
					<div class="form-group">
						<label for="password">비밀번호</label> <input type="password" name="userPw" class="form-control"
							id="userPw" placeholder="비밀번호 (영 대/소문자, 숫자 조합 8~16자 이상)"> <span id="msgPw"></span>
					</div>
					<div class="form-group">
						<label for="password-confrim">비밀번호 확인</label> <input type="password" class="form-control"
							id="pwConfirm" placeholder="비밀번호를 확인해주세요."> <span id="msgPw-c"></span>
					</div>
					<div class="form-group">
						<label for="name">이름</label> <input type="text" name="userName" class="form-control"
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" name="userPhone2" class="form-control phone2"
								id="userPhone2" placeholder="번호를 입력해주세요">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<div class="input-group-addon">
								<button type="button" class="btn btn-primary" id="addrbtn" onclick="searchAddress()" style="margin-bottom: -34px;">주소찾기</button>
							</div>
						</div>
					</div>
					<div class="form-group">
						<input type="text" name="userAddr" class="form-control" id="userAddr" placeholder="기본주소">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<button type="button" id="joinBtn" class="btn btn-lg btn-info btn-block">회원가입</button>
					</div>
				</form>
			</div>
		</div>
