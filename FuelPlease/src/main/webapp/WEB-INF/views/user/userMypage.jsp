...
<body>
								...
								<table class="table">
									<tbody class="m-control">
										...
										<tr>
											...
											<td><input class="form-control input-sm add" name="addrDetail" id="addrDetail"
	...
	<script>
		...
		document.getElementById('updateBtn').onclick = function() {
			// 비밀번호 변경 시 확인
			const userPw = document.getElementsByTagName('userPw').value;
			const userPwChk = document.getElementsByTagName('userPwChk').value;
			...
			// 이메일 인증 안한 경우
			const email1 = document.getElementById('userEmail1').value;			
			const userEmail1 = '${userInfo.userEmail1}'

			// console.log(userEmail1);
			// console.log(email1);
			
			if(email1 !== userEmail1 
				&& document.querySelector('.mail-check-input').disabled) {
					alert('이메일 인증을 해주세요');
					return;
			}
