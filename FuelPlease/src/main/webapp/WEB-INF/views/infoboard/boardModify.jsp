 ...
 <section>
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-9 write-wrap">
                        ...
                        <form action="${pageContext.request.contextPath}/infoboard/update" method="post" name="updateForm">
        ...
        <script>
            ...
            document.getElementById('listBtn').onclick = function() {
                location.href="${pageContext.request.contextPath}/infoboard/boardList";
            }
            ...
            document.getElementById('delBtn').onclick = () => {
                if(confirm('정말 삭제하시겠습니까?')) {
                    $form.setAttribute('action', '${pageContext.request.contextPath}/infoboard/delete');
